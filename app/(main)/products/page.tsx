...
const ProductsPage = () => {
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", padding: `0 ${sectionPadding}` }}>
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-[var(--primary)] mb-2">Loading Our Coffee Collection</h2>
              <p className="text-[var(--secondary)]">Discovering exceptional coffees from Mt. Elgon...</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#fcfaf8]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {filteredProducts.length === 0 ? (
              ...
              filteredProducts.map(product => {
                ...
                let fallbackImg = Math.random() > 0.5 ? "/coffee1.jpg" : "/coffee3.jpg";
      ...
      {/* Wholesale Section */}
      <section id="wholesale" style={{ maxWidth: "800px", margin: "0 auto", padding: `0 ${sectionPadding}` }}>
        <div className="py-8 md:py-12">
          ...
          <p className="text-[#1c140d] text-base font-normal mb-4">
            Partner with us to bring the exceptional taste of Mt. Elgon coffee to your customers. We offer competitive pricing, dedicated support, and a commitment to quality. Contact us today to learn more about wholesale opportunities.
          </p>
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3 bg-[#fcfaf8] rounded-xl p-3 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="flex py-3 justify-start">
            <a href="/contact" className="flex min-w-[84px] items-center justify-center rounded-xl h-10 px-4 bg-[#f38124] text-[#1c140d] text-sm font-bold hover:bg-[#e6731a] transition-colors">
              Contact Us
            </a>
          </div>
        </div>
      ...
      <section id="subscribe" style={{ maxWidth: "800px", margin: "0 auto", padding: `0 ${sectionPadding}` }}>
        <div className="py-8 md:py-12">
          <h2 className="text-[#1c140d] text-xl sm:text-2xl font-bold leading-tight tracking-[-0.015em] mb-2">Subscribe & Save</h2>
          <p className="text-[#1c140d] text-base font-normal mb-4">
            Never run out of your favorite coffee again! Subscribe to our coffee delivery service and enjoy regular shipments of freshly roasted beans, delivered right to your door. Plus, subscribers receive exclusive discounts and early access to new products.
          </p>
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3 bg-[#fcfaf8] rounded-xl p-3 shadow-sm hover:shadow-md transition-shadow">
              <span className="bg-[#f4ede7] rounded-lg p-2">
          ...
          <div className="flex py-3 justify-start">
            <a href="/dashboard/customer/subscriptions" className="flex min-w-[84px] items-center justify-center rounded-xl h-10 px-4 bg-[#f38124] text-[#1c140d] text-sm font-bold hover:bg-[#e6731a] transition-colors">
              Subscribe Now
            </a>
          </div>
        </div>
