  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section 
        ...
        style={{
          backgroundImage: "linear-gradient(rgba(0,0,0,0.1) 0%, rgba(0,0,0,0.4) 100%), url('/coffee4.jpg')",
          minHeight: "420px",
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-2xl mx-auto flex flex-col items-center justify-center gap-4 px-4">
          ...
          <h2 className="text-white text-base sm:text-lg font-medium mb-2 drop-shadow">
            Stay updated with the latest developments from Mt. Elgon Women in Specialty Coffee.
          </h2>
          <Link 
            href="/blog" 
              ...
              {searchTerm ? (
                <>
                  ...
                  <button
                    ...
                    className="mt-4 px-4 py-2 bg-[var(--primary)] text-white rounded-lg hover:bg-[var(--primary)]/90 hover:shadow-lg transition-all duration-200"
                  >
                    Clear Search
                  </button>
                </>
